...
{ Development of data adaption layer in .NET Core using Amazon technologies: Lambda, API gateway, Cloudwatch and DynamoDB.
    \begin{itemize}
        \item Reduction of 33\% in user runtime.
        \item Reduction of adaption errors using TDD.
    \end{itemize}
}
